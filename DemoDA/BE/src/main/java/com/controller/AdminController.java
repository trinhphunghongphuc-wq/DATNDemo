...
//    }
    ...
    @PostMapping("/batches/{id}/anchor-root")
    public AdminBatchListResponse anchorBatchRoot(@PathVariable Long id) throws Exception {
        return adminService.anchorBatchRoot(id);
    }
}